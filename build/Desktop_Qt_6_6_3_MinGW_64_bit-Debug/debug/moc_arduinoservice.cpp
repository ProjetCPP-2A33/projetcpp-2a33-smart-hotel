...
#include "../../../../sdfghjk/arduinoservice.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSArduinoENDCLASS_t qt_meta_stringdata_CLASSArduinoENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(8, 10),  // "idReceived"
        QT_MOC_LITERAL(19, 0),  // ""
        QT_MOC_LITERAL(20, 2),  // "id"
        QT_MOC_LITERAL(23, 14)   // "readSerialData"
    },
    "Arduino",
    "idReceived",
    "",
...
void Arduino::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->idReceived((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Arduino::idReceived; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Arduino::idReceived(const QString & _t1)
{
